...
?>
<div class="container bgOpacity my-5">
    ...
    <div class="row text-center my-4">
        <div class="col">
            <a href="https://github.com/YvanneROSAT/" class="btn text-white"><i class="bi bi-github">Voulez-vous voir mes projets sur Github ?</i></a>
        </div>
    </div>
